 ...
 **/
public class UserProfileMultiplePostsFragment extends Fragment implements View.OnClickListener {
    ...
    public UserProfileMultiplePostsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_user_profile_multiple_posts, container, false);
        initViews();
        setListeners();
        return view;
    }
